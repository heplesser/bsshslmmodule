...
void
bsshslm::register_eprop_iaf_bsshslm_2020( const std::string& name )
{
...
nest::RecordablesMap< bsshslm::eprop_iaf_bsshslm_2020 > bsshslm::eprop_iaf_bsshslm_2020::recordablesMap_;

namespace nest
{
template <>
void
RecordablesMap< bsshslm::eprop_iaf_bsshslm_2020 >::create()
{
  insert_( names::eprop_history_duration, &bsshslm::eprop_iaf_bsshslm_2020::get_eprop_history_duration );
  insert_( names::learning_signal, &bsshslm::eprop_iaf_bsshslm_2020::get_learning_signal_ );
  insert_( names::surrogate_gradient, &bsshslm::eprop_iaf_bsshslm_2020::get_surrogate_gradient_ );
  insert_( names::V_m, &bsshslm::eprop_iaf_bsshslm_2020::get_v_m_ );
}
}
